...
SWIGINTERN PyObject *_wrap_model_Predict(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  }
  {
    ...
    res2 = swig::asptr(obj1, &ptr);
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "model_Predict" "', argument " "2"" of type '" "std::vector< double,std::allocator< double > > const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "model_Predict" "', argument " "2"" of type '" "std::vector< double,std::allocator< double > > const &""'"); 
    }
    arg2 = ptr;
  }
  ...
  model_Predict(arg1,(std::vector< double,std::allocator< double > > const &)*arg2,*arg3);
  resultobj = SWIG_Py_Void();
  if (SWIG_IsNewObj(res2)) delete arg2;
  return resultobj;
fail:
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"model_Predict", _wrap_model_Predict, METH_VARARGS, (char *)"\n"
		"model_Predict(void * context, DoubleVector input, FloatVector output)\n"
		"\n"
		"Parameters\n"
		"----------\n"
		"context: void *\n"
